...
{																			//object for user
	...
	public function RegisterAccount()										//  user object's method that store the properties to database
	{
    	$con=connectdb();
    	mysqli_query($con,
		    "INSERT INTO `user`(`User_Password`, `User_Email`, `User_FirstName`, `User_LastName`, `User_Country`, `User_City`)
		    VALUES('$this->U_password','$this->U_email','$this->U_firstname','$this->U_lastname','$this->U_country','$this->U_city')"
	    );
	    mysqli_close($con);
	}
}
